...
var baseUrl = 'https://gnews.io/api/v4/search';
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, term, _c, lang, apiKey, url, response, error_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = event.queryStringParameters || {}, _b = _a.term, term = _b === void 0 ? 'news' : _b, _c = _a.lang, lang = _c === void 0 ? 'en' : _c;
            ...
            case 1:
                _d.trys.push([1, 3, , 4]);
                url = "".concat(baseUrl, "?q=").concat(encodeURIComponent(term), "&lang=").concat(lang, "&apikey=").concat(apiKey);
            ...
            case 3:
                error_1 = _d.sent();
                console.error('[fetchNews] Error:', error_1);
                return [2 /*return*/, {
                        statusCode: 500,
                        headers: {
                            'Content-Type': 'application/json',
